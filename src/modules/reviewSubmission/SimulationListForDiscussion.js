...
import { UnorderedListOutlined, ClockCircleOutlined, CommentOutlined } from '@ant-design/icons';
...
const SimulationListForDiscussion = () => {
                ...
                return {
                    ...
                    review: ({ id }) => (
                        <Button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/simulation-discussion-detail/${id}`);
                            }}
                            title="Thảo luận bài mô phỏng"
                        >
                            <CommentOutlined />
                        </Button>
                    ),
...
export default SimulationListForDiscussion;

            ...
            <div className={styles.kpiGrid}>
                ...
                <div className={styles.kpiCard}>
                    <div className={styles.kpiHeader}>
                        <span className={styles.kpiTitle}>Bài Mô Phỏng Active</span>
                    ...
                    <div>
                        ...
                        <div className={`${styles.kpiSubtext} ${styles.growth}`}>
                ...
                <div className={styles.kpiCard}>
                    <div className={styles.kpiHeader}>
                        <span className={styles.kpiTitle}>Giảng Viên Active</span>
                ...
                <div className={styles.kpiCardPending}>
                    <div className={styles.kpiHeader}>
                        <span className={styles.kpiTitle} style={{ color: 'inherit' }}>Việc Chờ Phê Duyệt</span>
                    ...
                    <div>
                        ...
                        <div className={styles.kpiSubtext}>
                            <span>Đăng ký, khóa học &amp; blogs</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className={styles.queueCard}>
                    <div className={styles.queueHeader}>
                        <div>
                            ...
                            <p className={styles.cardSubtitle} style={{ marginBottom: 0 }}>Xử lý hồ sơ giảng viên mới, xuất bản mô phỏng hoặc bài thảo luận.</p>
                        </div>
                                            ...
                                            pendingSimulations.map(sim => (
                                                <tr key={sim.id}>
                                                    <td>
                                                        ...
                                                        <div style={{ fontSize: 12, color: '#94a3b8' }}>{sim.category?.name} • Cấp {sim.level}</div>
                                                    </td>
                                ...
                                <table className={styles.customTable}>
                                    ...
                                    <tbody>
                                        {pendingBlogs.length === 0 ? (
                                            <tr>
                                                <td colSpan={3} style={{ py: 8, textAlign: 'center', color: '#94a3b8' }}>

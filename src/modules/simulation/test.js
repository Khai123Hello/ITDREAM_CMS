        ...
        <div style={{ padding: '24px', background: '#f1f5f9', minHeight: '100vh' }}>
            ...
            >
                <p style={{ color: '#64748b', marginBottom: '24px' }}>
                    Trang này được sử dụng để kiểm thử các tính năng mới trực quan. Dưới đây là demo tính năng kéo thả
                    Task và Subtask phân cấp bằng thư viện <code>@dnd-kit</code>.
                </p>
                <TaskSubTaskDnd />
            </Card>
        </div>

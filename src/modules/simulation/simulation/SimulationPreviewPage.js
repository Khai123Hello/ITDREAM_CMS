        ...
        >
            <div className="simulation-preview-root">
                <TaskContentLayout
                    ...
                    questionMap={{}}
                    requiresFileUpload={
                        previewSubtaskDetail?.submissionType === 1 || previewSubtaskDetail?.submissionType === 3
                    }
                    requiresTextResponse={
                        previewSubtaskDetail?.submissionType === 2 || previewSubtaskDetail?.submissionType === 3
                    }
                    previousFile={null}
                    previousText={''}
                    hasCompleted={false}

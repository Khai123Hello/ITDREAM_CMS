...
import { groupPermissionKindsOptions } from '@constants';
...
const PermissionForm = (props) => {
    ...
    const formWidth = useFormWidth();
    const { form, mixinFuncs, onValuesChange } = useBasicForm({
        onSubmit,
        setIsChangedFormValues,
    });

    const groupKindPermissionValues = translate.formatKeys(groupPermissionKindsOptions, ['label']);
    ...
    return (
        <Form
            style={{ width: formWidth ?? formSize[size] ?? size }}
            id={formId}
                ...
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        <SelectField
                            ...
                            name="kind"
                            options={groupKindPermissionValues}
                            required
                            disabled={isEditing}
                        />
                    </Col>

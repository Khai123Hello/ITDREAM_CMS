...
const GeneralSettingPage = ({ groupName }) => {
    ...
    const columnPage = [
        ...
        mixinFuncs.renderActionColumn(
            { editSetting: mixinFuncs.hasPermission([apiConfig.settings.update?.permissionCode]), delete: false },
            { width: '100px' },
        ),
    ];
    ...
    const columnGeneral = [
        ...
        mixinFuncs.renderActionColumn(
            {
                booleanSetting: mixinFuncs.hasPermission([apiConfig.settings.update?.permissionCode]),
                editSetting: mixinFuncs.hasPermission([apiConfig.settings.update?.permissionCode]),
                delete: false,
            },
            { width: '100px' },
        ),
    ...
    const columnsSlider = [
        ...
        mixinFuncs.renderActionColumn(
            { editSetting: mixinFuncs.hasPermission([apiConfig.settings.update?.permissionCode]), delete: true },
            { width: '60px' },
        ),
    ];

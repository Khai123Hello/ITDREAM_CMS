...
const apiConfig = {
    ...
    simulation: {
        ...
        getListForEducator: {
            baseURL: `${apiUrl}v1/simulation/educator_list`,
            method: `GET`,
            headers: baseHeader,
    ...
    taskQuestion: {
        getList: {
            baseURL: `${apiUrl}v1/task_question/list`,
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'TQ_L',
        },
    ...
    subtaskProgress: {
        ...
        studentList: {
            baseURL: `${apiUrl}v1/subtask-progress/student_list`,
            method: 'GET',
            headers: baseHeader,
    ...
    taskQuestionProgress: {
        answerList: {
            baseURL: `${apiUrl}v1/task-question-progress/answer_list`,
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'STTQ_ED_LR',
        },
        getList: {
        ...
        studentList: {
            baseURL: `${apiUrl}v1/task-question-progress/student_list`,
            method: 'GET',
            headers: baseHeader,
    ...
    review: {
        ...
        update: {
            ...
            method: 'PUT', // hoặc POST nếu backend dùng POST
            headers: baseHeader,
            permissionCode: 'RE_U',
        },
        delete: {
            baseURL: `${apiUrl}v1/review/delete`,
            method: 'DELETE', // hoặc POST nếu backend dùng POST
            headers: baseHeader,
            permissionCode: 'RE_D',
        },

        // Nếu vẫn cần client_list thì anh thêm vào
        getListForClient: {
            baseURL: `${apiUrl}v1/review/client_list`,
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'RE_L',
        },
    ...
    taskProgress: {
        list: {
            ...
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'STP_L',
        },
        get: {
            baseURL: `${apiUrl}v1/task_progress/get/:id`,
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'STP_V',
        },
        educatorGet: {
            baseURL: `${apiUrl}v1/task_progress/educator_get/:id`,
            method: 'GET',
            headers: baseHeader,
    ...
    comment: {
        ...
        create: {
            ...
            method: 'POST',
            headers: baseHeader,
            permissionCode: 'CM_US_C',
        },
        update: {
            baseURL: `${apiUrl}v1/comment/update`,
            method: 'PUT',
            headers: baseHeader,
            permissionCode: 'CM_US_U',
        },
        delete: {
            baseURL: `${apiUrl}v1/comment/delete/:id`,
            method: 'DELETE',
            headers: baseHeader,
            permissionCode: 'CM_US_D',
        },
    },
    feedback: {
        list: {
            baseURL: `${apiUrl}v1/feedback/list`,
            method: 'GET',
            headers: baseHeader,
            permissionCode: 'FB_L',
        },
    ...
    contacts: {
        ...
        getListClient: {
            baseURL: `${apiUrl}v1/contacts/client_list`,
            method: `GET`,
            headers: baseHeader,
    ...
    phoneCall: {
        ...
        employee: {
            getList: {
                baseURL: `${apiUrl}v1/phone-call/employee_list`,
                method: `GET`,
                headers: baseHeader,
    ...
    deviceEmployee: {
        ...
        getListForClient: {
            baseURL: `${apiUrl}v1/device-employee/client_list`,
            method: `GET`,
            headers: baseHeader,
            permissionCode: 'CNT_L',
        },
    ...
    message: {
        ...
        getListForClient: {
            baseURL: `${apiUrl}v1/message/client_list`,
            method: `GET`,
            headers: baseHeader,
    ...
    nation: {
        ...
        getClientList: {
            baseURL: `${apiUrl}v1/nation/client_list`,
            method: `GET`,
            headers: baseHeader,
            permissionCode: 'NAT_L',
        },
